...
interface SalesService {
    ...
    Optional<Sales>  createSalesRecode(String userId, NewSalesVo salesInfo);
}
...
public class SalesServiceImpl implements SalesService {
    ...
    @Override
    public Optional<Sales> createSalesRecode(String id, NewSalesVo salesInfo) {
