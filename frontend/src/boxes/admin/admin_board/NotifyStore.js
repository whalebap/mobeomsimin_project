...
const NotifyStore = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://3.34.251.151:8080/admins/report/list`)
      .then((res) => {
  ...
  const storeSearch = (searchWord) => {
    axios
      .get(`http://3.34.251.151:8080/admins/store/search/${searchWord}`)
      .then((res) => {
  ...
  const reportinitial = (id) => {
    axios
      .get(`http://3.34.251.151:8080/admins/store/report/initialization/${id}`)
      .then((res) => {
