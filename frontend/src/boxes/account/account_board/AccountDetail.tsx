...
const AccountDetail = () => {
  ...
  const handleUpdate = (e) => {
    ...
    axios
      .patch(`http://3.34.251.151:8080/users/${id}`, data)
      .then((response) => {
  ...
  const handleDelete = (e) => {
    e.preventDefault();
    axios
      .delete(`http://3.34.251.151:8080/users/${id}`)
      .then(() => {
  ...
  const handleUpdatePassword = (e) => {
    e.preventDefault();
    axios
      .post(`http://3.34.251.151:8080/users/${id}`, { password: password })
      .then(() => {
        if (newPassword === confirmNewPassword) {
          axios
            .patch(`http://3.34.251.151:8080/users/${id}`, {
  ...
  useEffect(() => {
    ...
    if (accountDetail.optionalAddr)
      setOptionalAddress(accountDetail.optionalAddr);
    ...
    <div className="container" id="account-detail">
      ...
      <form>
        <div className="form-group">
          ...
          <p>이름</p>
          <input type="text" className="form-control" readOnly value={name} style={{width: '100%'}} />
          <p>생년월일</p>
          <input
              style={{width: '100%'}}
            type="date"
          ...
          />
          <p>성별</p>
          <input type="text" className="form-control" readOnly value={gender} style={{width: '100%'}}/>
          <p>거주지 주소</p>
          <div className="input-group" style={{width: '100%'}}>
            <input
              type="text"
