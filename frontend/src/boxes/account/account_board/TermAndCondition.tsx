  ...
  return (
    <div className="container">
      <form>
        ...
        <textarea className="form-control" value={termOfService} readOnly style={{width:'100%'}}/>
        <div className="form-check">
          <input
            className="form-check-input"
            type="checkbox"
        ...
        <textarea className="form-control" value={privacyPolicy} readOnly style={{width:'100%'}}/>
        <div className="form-check">
          <input
            className="form-check-input"
            type="checkbox"
        ...
        <textarea className="form-control" value={userLocation} readOnly style={{width:'100%'}}/>
      </form>
      <div>
        <Link
          to="/"
          className="btn btn-danger"
          id="term-n-condition-cancel-button"
        >
          취소
        </Link>
        ...
        <button
          ...
          id="term-n-condition-confirm-button"
          onClick={handleNextJoinPage}
        >
          확인
        </button>
      </div>
